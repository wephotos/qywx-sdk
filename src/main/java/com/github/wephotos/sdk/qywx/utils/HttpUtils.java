...
import com.github.wephotos.sdk.qywx.exception.HttpClientException;
import com.github.wephotos.sdk.qywx.exception.HttpSessionInvalidException;
import com.github.wephotos.sdk.qywx.web.ThreadSession;
	...
	final static class HttpClientFactory {
		...
		private static CloseableHttpClient _initDefaultHttpClient() {
			try {
				...
				LoggerFactory.getLogger(HttpClientFactory.class).error("SSL设置错误", e);
